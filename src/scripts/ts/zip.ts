...
function generateSpeedoConfigVmt(speedoGroup: SpeedoGroup): string {
        return (
...
function generateSpeedoConfigRes(speedoGroup: SpeedoGroup): string {
        let s: string = "";
        let baseSlot: string;
...
function generateSpeedoConfigJSON(speedoGroup: SpeedoGroup): string {
        const tabSize = 4;
